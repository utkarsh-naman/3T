...
//func PrintGMap(data model.GMap) {
//	if len(data) == 0 {
...
//	keys := make([]model.State, 0, len(data))
//	for k := range data {
//		keys = append(keys, k)
//	}
//
...
//
//func SaveGMap(gmap model.GMap, filePath string) error {
...
//}
//
//func LoadGMap(filePath string) (model.GMap, error) {
